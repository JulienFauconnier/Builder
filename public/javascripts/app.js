...
function init(div) {
  $.widget('plb.content', {
    ...
    initDroppables: function initDroppables() {
      ...
      var that = this,
          droppables = $(".droppables-container .droppable, .droppables-container-nested .droppable");
