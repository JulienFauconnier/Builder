      ...
      div.selectable({
        ...
        selected: function selected(event, ui) {
          ...
          jQuery.each(elements, function (index, value) {
            var selectTagName = that.customParameters[value.tagName];
