  ...
  if (childNodes.length > 0 && nodeType !== "P") {
    ...
    try {
      for (var _iterator = childNodes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if ($(node).not(".js-off-canvas-exit")) obj[nodeType]["#"].push(DOMtoJSON(childNode));
      }
    } catch (err) {
      _didIteratorError = true;
      _iteratorError = err;
...
function JSONtoDOM(obj) {
  ...
  for (var testO in obj) {
    ...
    if (testO === "container" || testO === "row" || testO === "columns") tag = "div";else tag = testO;
...
},{"./content":305,"./responsive":311}],316:[function(require,module,exports){
"use strict";
